...
def test_current_user():
    ...
    try:
        ...
        user_data = data["data"]
        assert user_data["email"] == "dinhthongchau@gmail.com", "Email should be dinhthongchau@gmail.com"
...
def test_openapi_spec():
    ...
    try:
        ...
        assert "/api/v1/auth/current-user" in spec["paths"], "Should contain auth endpoint"
